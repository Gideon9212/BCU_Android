...
class ApkDownload : AppCompatActivity() {
    ...
    private suspend fun downloadAndInstall(version: String) {
        ...
        if (output.name.isBlank()) {
            ...
            val apkuri = FileProvider.getUriForFile(this@ApkDownload, "com.g2.bcu.provider", output)
    ...
    private suspend fun downloadApk(version: String) : File {
        ...
        return withContext(Dispatchers.IO) {
            ...
            val domain = "https://github.com/Gideon9212/bcu-assets/tree/master/apk/BCU_Android_"
            val end = "?raw=true"
