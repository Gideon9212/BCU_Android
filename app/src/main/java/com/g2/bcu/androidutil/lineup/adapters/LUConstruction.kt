...
class LUConstruction : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, group: ViewGroup?, bundle: Bundle?): View? {
        ...
        val texts = Array<TextInputEditText>(Data.BASE_TOT.toInt()) {
    ...
    private fun listeners(view: View) {
        val constructions = arrayOfNulls<TextInputLayout>(Data.BASE_TOT.toInt())
        val construction = view.findViewById<TextInputLayout>(R.id.constlev)
        val text = view.findViewById<TextInputEditText>(R.id.constlevt)
        val texts = arrayOfNulls<TextInputEditText>(Data.BASE_TOT.toInt())
