...
import com.g2.bcu.R
import com.g2.bcu.androidutil.StatFilterElement.Companion.statFilter
import com.g2.bcu.androidutil.io.AContext
import com.g2.bcu.androidutil.io.ErrorLogWriter.Companion.writeDriveLog
...
object StaticStore {
    ...
    val dataPath: String
        get() = Environment.getDataDirectory().absolutePath + "/data/com.g2.bcu/"
    ...
    fun decryptPNG(path: String, key: String, iv: String): String {
        ...
        val temp = Environment.getDataDirectory().absolutePath + "/data/com.g2.bcu/temp/"
        val g = File(temp)
        if (!g.exists()) {
            if (!g.mkdirs()) {
