...
class AssetDownloadService : Service() {
    companion object {
        const val PROGRESS_TEXT = "com.g2.bcu::Progress-Text"
        const val PROGRESS_PROGRESSION = "com.g2.bcu::Progress-Progression"
        const val SUCCESS = "com.g2.bcu::Success"
        const val FAILED = "com.g2.bcu::Failed"

        const val NOTIFICATION_ID = "com.g2.bcu::Download-Notification"
            ...
            try {
                ...
                if(musicList.isNotEmpty()) {
                    ...
                    for(music in musicList) {
                        ...
                        editor.putString(name, CommonStatic.getDataMaps().localMusicMap[name.toInt()])
                    }
                ...
                if(langList.isNotEmpty()) {
                    ...
                    for(lang in langList) {
                        ...
                        editor.putString(fileName, CommonStatic.getDataMaps().localLangMap[fileName])
