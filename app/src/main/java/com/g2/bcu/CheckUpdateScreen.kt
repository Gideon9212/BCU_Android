...
import com.g2.bcu.androidutil.ApkUpdateChecker
...
import com.g2.bcu.androidutil.io.AssetDownloadService
...
import com.g2.bcu.androidutil.supports.CustomAnimator
...
open class CheckUpdateScreen : AppCompatActivity() {
    ...
    private val hasAllAsset : Boolean
        get() {
            ...
            val require : Set<String> = UserProfile.getPool("required_asset")
