...
import com.g2.bcu.androidutil.battle.BBCtrl
import com.g2.bcu.androidutil.battle.BattleView
import com.g2.bcu.androidutil.battle.sound.PauseCountDown
import com.g2.bcu.androidutil.battle.sound.SoundHandler
import com.g2.bcu.androidutil.fakeandroid.AndroidKeys
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (bundle != null) {
            ...
            lifecycleScope.launch {
                ...
                val play = findViewById<FloatingActionButton>(R.id.battleplay)
                val skipFrame = findViewById<FloatingActionButton>(R.id.battlenextframe)
